...
# Crear certificado ocultando la salida
openssl genrsa -out key.pem 2048 > /dev/null 2>&1
(echo br; echo br; echo uss; echo speed; echo pnl; echo powermx; echo @powermx) | \
openssl req -new -x509 -key key.pem -out cert.pem -days 1095 > /dev/null 2>&1
cat key.pem cert.pem > /etc/stunnel/stunnel.pem
rm key.pem cert.pem

# Reiniciar servicio sin mostrar salida
